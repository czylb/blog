	...
	<div class="top">
		...
		<div class="nav">
			<ul>
				...
				<li>
					<a href="about1.php"target="blank"><span id="ge">个人资料</span></a>
			...
			<div class="rl">
				...
				<div id="fir">
					...
					<div class="sho">
            			...
            			<div><input type="radio" name="sex" value="male" />男
				...
				<div id="sec">
					...
					<div class="sho1">
						<form action="update_username.php" method="POST">
            				<div><input name="username"type="text"class="ur" /></div>
            				<div><input type="submit" class="bn" value="保存"></div>
        				</form>
        			</div>
				</div>
