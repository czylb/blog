	...
	<div class="top">
		...
		<div class="nav">
			<ul>
				...
				<li>
					<a href="essay.php"target="blank"><span id="ge">闲言碎语</span></a>
		...
		<div class="top-right">
			<div class="add"><a target="blank"href="add.php">发博文</a></div>
				...
				?>
			 	...
			 	<div class=ping>
			 		<div class="mi">
		                ...
		                <?php					
					include_once("conn/conn.php");		
					$sql=mysql_query("select pinglun1 from pinglun1");
					while($row = mysql_fetch_array($sql)){
						echo $row['pinglun1'];
					}
					echo "<br/><br/>";
					echo "回复评论:";					
					$name = $_SESSION["name"];			
					$sql=mysql_query("select pinglun from pinglun where name='".$name."'");
					while($row = mysql_fetch_array($sql)){
						echo $row['pinglun'];
					}
					?> 
