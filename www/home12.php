...
<div class="whole">
	<div class="top">
		...
		<div class="nav">
			<ul>
				<li>
					<a href="home12.php" target="blank"><span id="ren">个人中心</span></a>
					<p class="fly1">home</p>
				</li>
				<li>
		...
		<div class="top-right">
			<!-- <div class="add"><a target="blank"href="add.html">发博文</a></div> --><!-- php文件我没写这是发博文的php -->
		...
		<div class="middle">
			...
			<div id="right">
				<div class="up2">
			 		<p>相册</p>
			 		<!-- <a href="photo.html"target="blank">管理</a> -->
			 	</div>
			 	<div class="pp">
